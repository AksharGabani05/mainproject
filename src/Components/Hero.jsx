      ...
      <div className="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 hero-details">
        <div className="row g-4 justify-content-center justify-content-md-between align-items-center">
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto bg-white">
              <img src={orders} className="card-img-top img-fluid m-auto" alt="Fast Orders" />
              <div className="card-body">
                <p className="card-text mb-0 text-dark">Fast Orders</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto bg-white">
              ...
              <div className="card-body">
                <p className="card-text mb-0 text-dark">Quick Shipping</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto bg-white">
              ...
              <div className="card-body">
                <p className="card-text mb-0 text-dark">High Saves</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto bg-white">
              ...
              <div className="card-body">
                <p className="card-text mb-0 text-dark">24/7 Support</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto bg-white">
              ...
              <div className="card-body ">
                <p className="card-text mb-0 text-dark">Online Orders</p>
              </div>
            </div>
          </div>
        </div>
