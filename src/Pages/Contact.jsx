function Contact(){
    ...
    <div className="container-xxl">
      ...
      <div className="col-12 text-center">
            <h1 className=" text-warning">Reach Out to Us</h1>
        ...
        <div className="col-lg-6 col-md-12">
            <div className="card p-5">
                <h2 className='footer-title mb-3'><b>Contact Us</b></h2>
                  <p className='mb-2'><b>Address:</b>  408,AK House , Katargam ,Surat , 395005</p>
                  <p className='mb-2'><b>Phone:</b>  <a className='footer-tel text-decoration-none' href="tel:+919265947002">Call us at +91 9265947002</a></p>
      ...
      <div className="row">
        ...
        <div className="row g-3">
              ...
              <div className="col-12">
                  ...
                  <textarea className="form-control" placeholder="Text your message" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
                <div className='col-12 text-center gap-2'>
                <button id='button-link'className=" btn btn-success" type="submit">Submit</button>
                </div>
            </div>
          </div>
        </div>
